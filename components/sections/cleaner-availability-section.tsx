...
export function CleanerAvailabilitySection() {
  ...
  const availability = useCleanerAvailability({ activeOnly: true });

  const byCleaner = React.useMemo(() => {
  ...
  return (
    <Card className="rounded-2xl">
      <CardHeader className="pb-3">
        <CardTitle className="text-2xl font-bold ">Cleaner Availability</CardTitle>
      </CardHeader>
