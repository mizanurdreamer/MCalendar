  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-4 pr-6 shadow-lg transition-all data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-80 data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        success:
          "group border-success bg-success/15 text-foreground",
        warning:
          "group border-warning bg-warning/15 text-foreground",
        error:
          "group border-destructive bg-destructive/15 text-foreground",
      },
    },
