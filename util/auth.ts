...
export async function requireRole(...roles: (Role | UserRole)[]): Promise<AccessTokenPayload> {
...
export async function requireActor(...roles: (Role | UserRole)[]): Promise<ActorContext> {
