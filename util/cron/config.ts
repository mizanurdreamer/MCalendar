...
const AUTO_ASSIGN_ROOM_ATTENDANT_SCHEDULE_IN_MINUTES = toInt(
  process.env.CRON_AUTO_ASSIGN_ROOM_ATTENDANT_SCHEDULE_IN_MINUTES,
  60,
);
...
export const CRON_CONFIG = {
  ...
  AUTO_ASSIGN_ROOM_ATTENDANT_INTERVAL_MS: AUTO_ASSIGN_ROOM_ATTENDANT_SCHEDULE_IN_MINUTES * 60 * 1000,

  /** Enable/disable the auto-assign roomAttendant job */
  AUTO_ASSIGN_ROOM_ATTENDANT_ENABLED: process.env.CRON_AUTO_ASSIGN_ROOM_ATTENDANT_ENABLED !== "false",
